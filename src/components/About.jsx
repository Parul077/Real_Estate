    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center gap-10 md:gap-15">
        ...
        <div className="flex flex-col items-center md:items-start mt-10 md:mt-0 text-gray-600">
          ...
          <p className="my-10 max-w-lg text-sm">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Mollitia,
            impedit perspiciatis eos placeat veritatis ad nobis minima dolorum
            numquam a deleniti ipsam, necessitatibus reiciendis quisquam.
          </p>
